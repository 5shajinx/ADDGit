...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        CGFloat btnW = 70;
        CGFloat btnH = 30;
        _countBtn = [[UIButton alloc] initWithFrame:CGRectMake(kscreenWidth - 80, 25, btnW, btnH)];
        ...
        [_countBtn.layer setBorderWidth:2];
        _countBtn.layer.borderColor=[UIColor lightGrayColor].CGColor;
        ...
        _countBtn.backgroundColor = [UIColor colorWithWhite:0.7 alpha:0.5];
        _countBtn.layer.cornerRadius = 15;
