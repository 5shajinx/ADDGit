...
@interface ZMDZBViewController ()

@end

@implementation ZMDZBViewController
...
- (void)setUpTabBarItem {
    UITabBarItem *tabBarItem  = [[UITabBarItem alloc]initWithTitle:@"视听" image:[UIImage imageNamed:@"dianshitai"] selectedImage:[UIImage imageNamed:@"dianshitai"]];
