...
@interface ZMDNCenterViewController ()<UIWebViewDelegate>
{
    MBProgressHUD *hud;
}
...
@implementation ZMDNCenterViewController
...
- (void)simpleUIWebViewTest {
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@",[arr[1] objectForKey:@"menu_url"]];
