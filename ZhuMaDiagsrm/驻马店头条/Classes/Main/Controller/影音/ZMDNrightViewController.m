...
@interface ZMDNrightViewController ()<UIWebViewDelegate>
{
    MBProgressHUD *hud;
}
...
@implementation ZMDNrightViewController
...
- (void)simpleUIWebViewTest {
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@",[arr[2] objectForKey:@"menu_url"]];
