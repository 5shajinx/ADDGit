...
- (void)commonInit{
    ...
    backgroudView_ = [[UIImageView alloc] initWithFrame:CGRectMake(0, 20, ScreenW, 44)];
    [self addSubview:backgroudView_];
    
    scrollView_ = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 20, ScreenW, 44)];
...
- (void)setTabbarItems:(NSArray *)tabbarItems{
    if (_tabbarItems != tabbarItems) {
        ...
        for (DLFixedTabbarViewTabItem *item in tabbarItems) {
            ...
            label.font = [UIFont  fontWithName:@"STHeitiSC-Light" size:20.0];
