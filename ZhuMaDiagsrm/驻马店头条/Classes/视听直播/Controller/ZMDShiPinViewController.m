...
static NSString *zhiboString = @"ZhiBoChasshipin";
//shipin直播
#import "ZMDShiPinViewController.h"

@interface ZMDShiPinViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger page;
    NSString *string;
    NSString *timeSp;
...
@implementation ZMDShiPinViewController
...
-(void)lodxiala
{
    ...
    NSString *urlString = @"http://zmdtt.zmdtvw.cn/index.php/api/index/zb?page=1&type=1";
...
-(void)lodshangla
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://zmdtt.zmdtvw.cn/index.php/api/index/zb?page=%ld&type=1",page];
