...
//图文直播
static NSString *zhiboString = @"ZhiBoChasafff";

@interface ZMDPicTextZBViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger page;
    NSString *string;
    NSString *timeSp;
...
@implementation ZMDPicTextZBViewController
...
- (void)viewDidLoad {
    ...
    [self.myTableView registerNib:[UINib nibWithNibName:@"ZHIBOCell" bundle:nil] forCellReuseIdentifier:@"cell"];
    UIView *vie = [[UIView alloc]initWithFrame:CGRectMake(0, 0, ScreenW, 30)];
    self.myTableView.tableFooterView = vie;
...
-(void)lodxiala
{
    ...
    NSString *urlString = @"http://zmdtt.zmdtvw.cn/index.php/api/index/zb?page=1&type=0";
...
-(void)lodshangla
{
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://zmdtt.zmdtvw.cn/index.php/api/index/zb?page=%ld/type=0&type=0",page];
