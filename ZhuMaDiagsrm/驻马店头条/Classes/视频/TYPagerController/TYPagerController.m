...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:26/255.0 green:167/255.0 blue:242/255.0 alpha:1];
...
- (void)reSizeContentView
{
    ...
    if ([Manager sharedManager].lv == 0){
        _contentView.frame = CGRectMake(0, contentTopEdging+32*Kscalew, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame) - contentTopEdging);
    }
    if ([Manager sharedManager].lv == 1000){
        _contentView.frame = CGRectMake(0, contentTopEdging+15*Kscalew, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame) - contentTopEdging);
    }
